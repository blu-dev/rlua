...
macro_rules! inc_top {
    ($l:ident) => {{
        *(($l as *const u8).add(0x10) as *mut *mut TValue) = (*(($l as *const u8).add(0x10) as *mut *mut TValue)).add(1);
    }}
}
// this is not in smash big sadge
pub static mut lua_ident: [::std::os::raw::c_char; 0usize] = [];

#[skyline::from_offset_static(0x4860ab0)]
pub static mut luaO_nilobject: TValue;
...
pub fn index2addr(L: *mut lua_State, idx: ::std::os::raw::c_int) -> *mut TValue {
    unsafe {
        ...
        if idx > 0 {
            ...
            if o >= l_access!(top, L) {
                return luaO_nilobject.deref_mut() as _;
            } else {
                return o;
            }
...
pub fn lua_gettop(L: *mut lua_State) -> ::std::os::raw::c_int {
    unsafe {
        l_access!(top, L).offset_from(l_access!(ci_func, L).add(1)) as _
    }
}
...
pub fn lua_settop(L: *mut lua_State, idx: ::std::os::raw::c_int) {
    unsafe {
        ...
        if idx >= 0 {
            ...
            *((L as *const u8).add(0x10) as *mut *mut TValue) = l_access!(top, L).offset((idx + 1) as isize);
        }
    }
}
...
pub fn reverse(L: *mut lua_State, mut from: *mut TValue, mut to: *mut TValue) {
    unsafe {
        while from < to {
            let mut tmp = TValue { value: Value { object: std::ptr::null_mut() }, tt: 0 };
            tmp = *from;
            *from = *to;
            *to = tmp;
...
pub fn auxgetstr(L: *mut lua_State, value: *mut TValue, k: *const std::os::raw::c_char) -> ::std::os::raw::c_int;
...
{
    unsafe {
        auxgetstr(L, index2addr(L, idx), k)
    }
}
...
pub fn luaH_resize(L: *mut lua_State, table: *mut ::std::os::raw::c_void, arrsize: u32, mapsize: u32);
...
pub unsafe extern "C" fn printf(__format: *const ::std::os::raw::c_char, ...) -> ::std::os::raw::c_int {
    unimplemented!()
}
...
pub unsafe extern "C" fn scanf(__format: *const ::std::os::raw::c_char, ...) -> ::std::os::raw::c_int {
    unimplemented!()
}
...
pub unsafe extern "C" fn sscanf(
    ...
    pub unsafe extern "C" fn scanf1(__format: *const ::std::os::raw::c_char, ...) -> ::std::os::raw::c_int {
    unimplemented!()
}
